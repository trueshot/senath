...
var facetMap = {
  ...
  '--facet-buyjourney-design': { file: 'buyjourney-design.md', desc: 'Buy-ProduceFlow-SaaS journey record (DESIGN ONLY, NOT BUILT, 2026-09-20) — third journey class: prospect-grain jrec born at first plan-carrying event, anti-fork identity gate, resolves into order-grain jrec:onboard at payment. Feeds the prospect PM buy-flow-presentation.md.' }
};
